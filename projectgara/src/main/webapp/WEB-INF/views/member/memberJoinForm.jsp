				...
				<div class="card">
					<div class="card-body">
                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1"
						...
						<form id="formAuthentication" class="mb-3" action="memberJoin.do"
							method="POST">
							<div class="mb-3">
							...
							<div class="mb-3 form-password-toggle">
								...
								<div class="input-group input-group-merge">
									<input type="password" id="memberPassword" class="memberPassword"
										name="password"
										placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
							...
							<div class="mb-3">
								<div class="form-check">
									<input class="form-check-input" type="password"
										id="chkPassword" name="chkPassword" /> Remember Me
